...
const ColumnAdder = ({ setShowColumnForm }: Props) => {
  ...
  return (
    <div
      className="min-w-[90%] md:min-w-[65%] mt-[125px] md:mt-[145px] flex items-center justify-center min-h-[75vh] bg-gradient-to-b from-white to-transparent dark:from-darkTiles rounded-lg cursor-pointer"
