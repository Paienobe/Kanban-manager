...
const BoardForm = ({ showBoardForm, setShowBoardForm }: Props) => {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="bg-lightTiles dark:bg-darkTiles transition-[background] duration-300 ease-in-out p-4 rounded-xl w-[90%] md:w-[65%] text-left max-h-[90vh] overflow-y-auto lg:w-[45%] lg:max-w-[501px]"
      >
